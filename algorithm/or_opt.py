...
def solve(N: int, K: int, c: 'list[list]') -> list:
    ...
    def delta_insert(s: int, e: int, insert_pos: int) -> int:
        return - c[route[insert_pos-1]][route[insert_pos]]\
    ...
    for i in range(MAX_ITER):
        ...
        for cand in cands:
            ...
            for e in e_range:
                ...
                best_delta_insert = check_delta = - removing_delta
                ...
                for insert_pos in range(s-1, 0, -1):
                    ...
                    d_insert = delta_insert(s, e, insert_pos)
                    if best_delta_insert > d_insert:
                        best_delta_insert = d_insert
                        move = (s, e, insert_pos)
                ...
                if best_delta_insert < check_delta:
                    break
